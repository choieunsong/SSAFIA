...
- 이 페이지에 접속할 때 번거롭게 회원가입할 필요 없이 구글 계정으로 로그인 가능합니다.

## 화상 미팅 기능

- openvidu를 활용하여 생성된 방에 입장한 사람들끼리 화상미팅을 진행할 수 있습니다.
- 동시에 말할 때 헷갈리지 않도록 현재 말하는 사람이 누구인지 표시됩니다.

### 마피아 게임기능

- webSocket 기술을 이용하여 마피아 게임 기능을 구현했습니다.
- 실제 친구들과 모여서 하던 것처럼 말하고, 투표하고, 정치할 수 있도록 되어있습니다.
- 마피아끼리 소근소근거리면서 누굴 제거할 지 고민하던 부분 또한 재현되어 있습니다.
- 죽은 사람은 더 이상 말을 못 하는 대신에 다른 사람들 뭐하는 지 볼 수 있던 것까지 재현되어 있습니다.
- 투표기능
  - 투표하고 싶은 사람을 클릭하면 그 사람에게 투표할 수 있도록 되어있습니다.
  - 제한시간 안에는 투표를 바꿀수도 있고 취소할 수도 있게 되어있습니다.
  - 더 이상 바꿀 마음이 없다면 투표를 확정할 수도 있도록 되어있습니다.
- 관전기능
